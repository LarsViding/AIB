...
$myVersion2 = $allOnVersion | Where-Object { $_.Architecture -eq 'x64' }
$myMSIVersion = $myVersion2 | Where-Object { $_.Type -eq 'msi' }
$myVersion = $myMSIVersion | Where-Object { $_.Ring -eq 'General' }
