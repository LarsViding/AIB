...
Set-Content C:\AzureDevOps-LarsViding\AIB-LV\identityNameId.txt $identity.Id
...
$myRoleImageCreationPath = "C:\AzureDevOps-LarsViding\AIB-LV\myRoleImageCreation.json"
